    ...
    <div className={style.headerwrapper}>
        ...
        <div className={style.headermain}>
            ...
            <div className={style.navelement}>
                {props.data.map(block => <Navblock logoutUserHandler={props.logoutUserHandler} key={block.text} headerType={props.headerType} sendCategory={props.sendCategory} data={block}/>
